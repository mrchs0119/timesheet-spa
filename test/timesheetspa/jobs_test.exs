defmodule Timesheetspa.JobsTest do
  ...
  describe "jobs" do
    ...
    @valid_attrs %{desc: "some desc", hours: 42, jobCode: "some jobCode", name: "some name"}
    @update_attrs %{desc: "some updated desc", hours: 43, jobCode: "some updated jobCode", name: "some updated name"}
